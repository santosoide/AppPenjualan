                        ...
                        <div id="form1" style="display: none ;">
                            ...
                            {{ Form::hidden('', Input::old(''),array('id' => 'current_page')) }}
                                ...
                                <div class="control-group">
                                    {{ Form::label('nota_jual', 'No Nota', array('class' => 'control-label')) }}
                                    <div class="controls controls-row">
                                        {{ Form::text('nota_jual', Input::old('nota_jual'), array('class' => 'span4'))}}
                                    </div>
                                </div>

                                {{--tgl_jual--}}
                                <div class="control-group">
                                    {{ Form::label('tgl_jual', 'Tgl Transaksi', array('class' => 'control-label')) }}
                                    <div class="controls controls-row">
                                        {{ Form::text('tgl_jual', Input::old('tgl_jual'), array('class' => 'span4','data-date-format' => 'yyyy-mm-dd'))}}
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls controls-row">
                                        {{ Form::text('nama_pembeli', Input::old('nama_pembeli'), array('class' => 'span4'))}}
                                    </div>
                                </div>

                                {{--barang yang diinput ke db adl id_barang--}}
                                <div class="control-group">
                                    ...
                                    <div class="controls controls-row">
                                        ...
                                        {{ Form::hidden('id_barang', Input::old('id_barang'),array('id' => 'id_barang')) }}
                                    </div>
                                </div>

                                {{--jml pembelian--}}
                                <div class="control-group">
                                    {{ Form::label('jml', 'Jumlah', array('class' => 'control-label')) }}
                                    <div class="controls controls-row">
                                        {{ Form::text('jml', Input::old('jml'), array('class' => 'span4'))}}
                                    </div>
                                </div>
                                ...
                                <div class="form-actions bg-silver">
                                    {{ Form::submit('Simpan', array('class' => 'btn btn-primary','id' =>'btnSimpan','onclick' => 'jQuery("html, body").animate({ scrollTop: 0 }, "slow");')) }}
